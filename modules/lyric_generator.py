...
class LyricGenerator:
    ...
    def generate_line(self):
        ...
        """
        patterns = [
            lambda: (f"{random.choice(self.word_bank['adjectives'])} "
                     f"{random.choice(self.word_bank['nouns'])} "
                     f"{random.choice(self.word_bank['verbs'])}"),
            lambda: (f"I {random.choice(self.word_bank['verbs'])} "
                     f"the {random.choice(self.word_bank['adjectives'])} "
                     f"{random.choice(self.word_bank['nouns'])}"),
            lambda: (f"When {random.choice(self.word_bank['nouns'])} "
                     f"{random.choice(self.word_bank['verbs'])}"),
            lambda: random.choice(self.word_bank['phrases']),
            lambda: (f"The {random.choice(self.word_bank['nouns'])} "
                     f"is {random.choice(self.word_bank['adjectives'])}"),
        ]
    ...
    def _generate_title(self):
        ...
        """
        title_patterns = [
            lambda: (f"{random.choice(self.word_bank['adjectives']).title()} "
                     f"{random.choice(self.word_bank['nouns']).title()}"),
